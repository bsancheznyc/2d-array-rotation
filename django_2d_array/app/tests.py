...
class TestGridGenerator(TestCase):
    ...
    @pytest.mark.skip(reason = "fixing test_2_x_2")
    def test_0_x_0(self):
        columns, rows  = 0, 0
        response = grid_generator(self, columns, rows)
    ...
    @pytest.mark.skip(reason = "fixing test_2_x_4")
    def test_2_x_2(self):
        columns, rows = 2, 2
        response      = grid_generator(self, columns, rows)
    ...
    @pytest.mark.skip(reason = "fixing test_1_x_2")
    def test_2_x_4(self):
        columns, rows  = 2, 4
        response       = grid_generator(self, columns, rows)
        self.assertEqual(response, [['A0', 'A1'], ['A7', 'A2'], ['A6', 'A3'], ['A5', 'A4']])

    @pytest.mark.skip(reason = "fixing hold")
    ...
    @pytest.mark.skip(reason = "fixing test_10_x_2")
    def test_1_x_2(self):
        columns, rows  = 1, 2
        response = grid_generator(self, columns, rows)
        self.assertEqual(response, [['A0'], ['A1']] )

    @pytest.mark.skip(reason = "fixing test_1_x_1")
